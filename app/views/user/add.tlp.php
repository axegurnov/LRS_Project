...
<div class="container mt-4">
    ...
    <form action="/user/add" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="surname" class="form-control" id="inputSurname" aria-describedby="surnameHelp" placeholder="Enter surname" value="<?=(empty($_POST['surname'])) ? '' : $_POST['surname']?>">
        </div>
        <div class="form-group">
