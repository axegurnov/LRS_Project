...
<ul>
  <li>3.1. Все таблицы - "php cli.php fill" или "php cli.php fill table"</li>
  <li>3.2. Конкретная таблица - "php cli.php fill table <название_таблицы>"</li>
</ul>
  4. Очистка данных:
<ul>
  <li>4.1. Все таблицы - "php cli.php clear" или "php cli.php clear table"</li>
...
<ul>
  ...
  6. Выполнение персональной миграции, непредусмотренной заранее. Различается по типам:
<ul>
  <li>6.1. Изменение базы данных - "php cli.php personal database <название_файла_sql>"</li>
  <li>6.2. Изменение таблицы - "php cli.php personal table <название_файла_sql>"</li>
</ul>
  Прим: <название_файла_sql> может сожержать либо полное название исполняемого файла sql, либо маску, удовлетворяющую условию функции glob() в php. 
<br>
База данных LRS.<br>
<br>
